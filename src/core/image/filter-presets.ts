...
export const FILTER_PRESETS: readonly FilterPreset[] = [
  ...
  { id: 'warm', label: 'Warm', filters: { ...DEFAULT_FILTERS, sepia: 0.25, saturate: 1.2, hueRotate: -8 } },
  { id: 'cool', label: 'Cool', filters: { ...DEFAULT_FILTERS, saturate: 1.05, hueRotate: 12, brightness: 1.03 } },
  { id: 'fade', label: 'Fade', filters: { ...DEFAULT_FILTERS, contrast: 0.8, brightness: 1.1, saturate: 0.8 } },
  { id: 'dramatic', label: 'Drama', filters: { ...DEFAULT_FILTERS, contrast: 1.4, brightness: 0.9, saturate: 0.9 } },
];
