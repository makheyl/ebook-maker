      ...
      {PAGE_SIZE_PRESETS.map((preset) => {
        ...
        return (
          <button
            ...
            className={cn(
              'flex flex-col items-center gap-2 rounded-lg border bg-card p-3 text-center transition-colors hover:border-primary/60',
          ...
          >
            <span className="grid h-16 w-full place-items-center">
              <span
                className={cn(
                  'block rounded-sm border-2 bg-muted',
